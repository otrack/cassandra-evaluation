...
def main():
    ...
    with open(output_tikz, 'w') as f:
        ...
        for wl_index, workload in enumerate(workloads):
            for op_index, op in enumerate(all_ops):
                ...
                for proto_idx, proto in enumerate(protocol_order):
                    ...
                    f.write("          };\n")
                # Optimum
                f.write("          \\addplot+[black, ultra thick, dashed, mark=none] table {\n")
        ...
        f.write("    \\caption{CDF of operation latencies for different workloads and protocols. ")
        for idx, proto in enumerate(protocol_order):
            ...
            if idx < len(protocol_order) - 1:
                f.write(", ")
        # Optimum
        f.write(r", \protect\tikz \protect\draw[black, thick, dashed] (0,0) -- +(0.8,0);~optimum. ")
        f.write("The optimum is shown as a dashed black line.}\n")
